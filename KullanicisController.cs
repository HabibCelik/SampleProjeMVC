...
namespace PersonelDeparmanMVCProject.Controllers
{
    ...
    {
        private PersonlDepartmanDBEntities db = new PersonlDepartmanDBEntities();
        ...
        public ActionResult Create([Bind(Include = "Id,Ad,Soyad,Role")] Kullanici kullanici)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Ad,Soyad,Role")] Kullanici kullanici)
        {
            if (ModelState.IsValid)
            {
